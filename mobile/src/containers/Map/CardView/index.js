...
import OpenAndDistance from '../../../components/OpenAndDistance';
  ...
  onGetDistance = () => {
    fetch(
      `https://maps.googleapis.com/maps/api/distancematrix/json?origins=${
        this.props.regionLat
      },${this.props.regionLng}&destinations=${this.props.latitude},${
